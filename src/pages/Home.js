...
import ResolveDomain from "./Search";
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center">
          <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block xl:inline"> { MdOutlineTableChart } BlockCharts; Web3 Indexing platform</span>{" "}
            <span className="block text-indigo-500 xl:inline">
            <p></p>All the moves that matters in one place
            </span>
          </h1>
